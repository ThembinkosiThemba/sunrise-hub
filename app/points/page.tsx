...
export default function PointsPage() {
  ...
  const pointsByType = pointsData.recent_activities.reduce((acc, activity) => {
    acc[activity.activity_type] =
      (acc[activity.activity_type] || 0) + activity.points;
    return acc;
    ...
    <div className="min-h-screen">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <Card className="mx-auto mt-8 max-w-md border-2 border-primary/20 bg-card">
              <CardContent className="p-8">
                <p className="text-sm text-description">Your Total Balance</p>
                ...
                <p className="mt-2 text-sm text-description">Sunrise Points</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center font-serif text-4xl font-bold text-brand">
            How to Earn Points
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-center text-description">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="border-2 transition-shadow hover:shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="mt-2 text-sm text-description">
                  Earn 10% of your purchase amount in points
                </p>
            ...
            <Card className="border-2 transition-shadow hover:shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="mt-2 text-sm text-description">
                  Get points when you redeem gift vouchers
                </p>
            ...
            <Card className="border-2 transition-shadow hover:shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="mt-2 text-sm text-description">
                  Like businesses and send messages
                </p>
                <Badge className="mt-4 bg-secondary/10 text-secondary">
                  10 Points
                </Badge>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 transition-shadow hover:shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="mt-2 text-sm text-description">
                  Bonus points from merchant campaigns
                </p>
                <Badge className="mt-4 bg-primary/10 text-primary">
                  Varies
                </Badge>
            ...
            {Object.entries(pointsByType).map(([type, points]) => (
              <Card key={type} className="border-2">
                ...
                <CardContent>
                  ...
                  <p className="mt-2 text-sm text-description">
                    {((points / pointsData.total_points) * 100).toFixed(1)}% of
                    total
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4 py-16 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg opacity-90">
              Redeem your Sunrise Points for exclusive rewards and discounts
            </p>
